...
class Author(models.Model):
    ...
    class Meta:
        managed = False # This tells Django not to manage this model's table
        db_table = "authors" # Matches the name of the existing table
...
class Books(models.Model):
    ...
    class Meta:
        managed = False # This tells Django not to manage this model's table
        db_table = "books" # Matches the name of the existing table
...
class Publisher(models.Model):
    ...
    class Meta:
        managed = False # This tells Django not to manage this model's table
        db_table = "publishers" # Matches the name of the existing table
...
class User(models.Model):
    ...
    class Meta:
        managed = False # This tells Django not to manage this model's table
        db_table = "users" # Matches the name of the existing table
